...
int main(int argc, char** argv) {
  ...
  std::string urdfFile;
  try {
    urdfFile = ament_index_cpp::get_package_share_directory("kbot_v2_description") + "/urdf/robot.urdf";
  ...
  // Initialize states
  Eigen::VectorXd q = Eigen::VectorXd::Zero(26);
  q[2] = 0.8415;
